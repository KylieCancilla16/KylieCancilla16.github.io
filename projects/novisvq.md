...
<img src="../img/novisvq_architecture (1).jpg" class="img-thumbnail" alt="NovisVQ model architecture">
<img src="../img/conclusion_graph_378_raw.jpg" class="img-thumbnail" alt="Model transfer to real world data Comparison graph">
<img src="../img/novis_val_graph_dif_augs_sine.yaml.jpg" class="img-thumbnail" alt="Model val curves comparison">
