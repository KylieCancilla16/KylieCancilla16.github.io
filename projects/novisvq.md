...
<img src="../img/novis_val_graph_dif_augs_sine.yaml.jpg" class="img-thumbnail" alt="Model val curves comparison" style="width:40%">
<img src="../img/conclusion_graph_378_raw.jpg" class="img-thumbnail" alt="Model transfer to real world data Comparison graph" style="width:40%">
